...
<div class="Content bmAudioSettings">
    ...
    <input type="text" name="UserID" value="<?php echo $currentuserid;?>" height="0px" width="0px" style="pointer-events:none;opacity:0;color:transparent;">
        ...
        <span onMouseDown="hl2_click();"><input type="radio" id="t_hl2" name="type" width="100%" value="hl2"<?php echo $r_hl2_ch;?>><label for="t_hl2">GMod / HL2</label></span><br>
        <span onMouseDown="quake_click();"><input type="radio" id="t_quake" name="type" width="100%" value="quake"<?php echo $r_quake_ch;?>><label for="t_quake">Quake 3</label></span><br>
        <span><input type="radio" id="t_custom" name="type" width="100%" value="custom"<?php echo $r_custom_ch;?>><label for="t_custom">Custom</label></span><br>
        </div>
